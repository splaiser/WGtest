...
class FirstExampleBuffer:  # Данный метод при использовании беблиотеки collections позволят указать
    # максимальное количество символов в буфере тем самым,
    # если количество символов меньше указанного нами максимального
    # колчичества новый символ будет добавлен и ничего не удалиться,
...
class SecondExampleBuffer:  # Данный метод при использовании if\else так позволят указать максимальное количество символов
    # в буфере тем самым,если количество символов меньше указанного нами
    # максимального колчичества новый символ будет добавлен и ничего не удалиться,
    # что и подразумивает циклический буфер. Данный способ занимает больше
